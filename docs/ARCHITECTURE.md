...
- `tests/unit/*.test.ts` — vitest + happy-dom; 253 tests covering engine
...
- `tests/e2e/*.spec.ts` — Playwright on `mobile-chrome`; 32 tests
  covering adapters, a11y (axe-core), pull-to-refresh, soft keyboard,
